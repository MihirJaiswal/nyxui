  ...
  examples: [
    {
      ...
      preview: (
        <div className="p-8 bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-blue-100 dark:border-blue-900/30 transition-all duration-300 hover:shadow-xl">
          ...
          <ScrollAnimationTrigger effect="fade" threshold={0.2} delay={0.2}>
            <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
              Fade In Animation
            </h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              This content smoothly fades into view as it enters the viewport,
              creating a clean and elegant transition that enhances the user
              experience.
            </p>
      ...
      preview: (
        <div className="p-8 bg-white dark:bg-neutral-800 rounded-xl shadow-lg border border-green-100 dark:border-green-900/30 transition-all duration-300 hover:shadow-xl">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              This content gracefully slides up into position as you scroll,
              creating a natural flow that guides the user through your content.
            </p>
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <p className="text-white/80 leading-relaxed">
                This content uses complex custom animations with diagonal
                movement, rotation, and scaling for maximum visual impact.
              </p>
    ...
    },
    {
      ...
      preview: (
        <div className="p-8 bg-white dark:bg-yellow-950 rounded-xl shadow-lg border border-amber-100 dark:border-amber-900/30 transition-all duration-300 hover:shadow-xl">
          ...
          <ScrollAnimationTrigger effect="scale" threshold={0.2} duration={0.7}>
            <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
              Scale Animation
            </h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Watch as this content smoothly scales from small to full size as
              you scroll, creating an eye-catching effect that emphasizes
        ...
        <div className="p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-pink-100 dark:border-pink-900/30 transition-all duration-300 hover:shadow-xl">
          ...
          >
            ...
            <p className="leading-relaxed">
              This content transforms through a beautiful color transition as it
              enters your view, creating a visually engaging experience.
            </p>
        ...
        <div className="p-8 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl shadow-lg text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <ScrollAnimationTrigger effect="fade" threshold={0.2} delay={0.7}>
                <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
