...
import { Play, Pause, Copy, Check, RotateCcw, Maximize2, Minimize2, Download } from "lucide-react"
...
export function AnimatedCodeBlock({
  ...
  const getThemeStyles = (): ThemeStyles => {
    switch (theme) {
      ...
      case "cyberpunk":
        return {
          background: "bg-violet-950 bg-gradient-to-br from-violet-950 to-fuchsia-950",
          text: "text-fuchsia-300",
          lineNumbers: "text-violet-600",
          highlight: "bg-fuchsia-900/30",
          border: "border-fuchsia-800",
          header: "bg-violet-900 bg-gradient-to-r from-violet-900 to-fuchsia-900",
  ...
  return (
    ...
    >
      ...
      <div className={cn("flex items-center justify-between p-3 border-b border-opacity-20", themeStyles.header)}>
      ...
      >
        <div className="flex items-center gap-2">
          <div className={cn("w-2 h-2 rounded-full", isPlaying ? "bg-green-500" : "bg-gray-500")}></div>
