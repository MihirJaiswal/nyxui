    ...
    <div className="w-full min-h-screen text-white p-2">
      <div className="w-full max-w-6xl mx-auto">
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 dark:from-blue-400 via-violet-600 dark:via-violet-400 to-pink-400">
            Animated Gradient Background
          </h1>
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            Create stunning, interactive gradient backgrounds for your UI with
          ...
          <div className="relative h-96 w-full">
            ...
            <div className="relative z-10 p-8 h-full flex flex-col items-center justify-center">
              ...
              <p className="text-lg text-white/90 text-center max-w-lg mb-6 drop-shadow">
                Enhance your UI with smooth, customizable animated gradients
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col items-center justify-center text-white text-center p-4">
                  ...
                  <p className="text-sm opacity-80">
                    {config.pattern.charAt(0).toUpperCase() +
                      config.pattern.slice(1)}{" "}
                    pattern
                  </p>
                </div>
              </Card>
                  ...
                  <div className="relative h-64 w-full">
                    ...
                    <div className="relative z-10 p-6 h-full flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-white/90 max-w-md">
                        ...
                        {patternType === "linear" &&
                          "Transitions colors along a straight line in a specified direction."}
                        {patternType === "conic" &&
                          "Sweeps colors around a center point like a color wheel."}
                        {patternType === "mesh" &&
                          "Creates multiple overlapping radial gradients for a complex, layered effect."}
                        {patternType === "noise" &&
                          "Applies a textured noise pattern over the gradient for added depth."}
                        {patternType === "waves" &&
                          "Creates flowing, wave-like patterns that add movement to the gradient."}
                      </p>
                    </div>
                  </div>
                </Card>
