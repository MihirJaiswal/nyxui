    ...
    <div className="relative overflow-hidden rounded-2xl p-6 md:p-8 lg:p-10 shadow-lg">
      ...
      <div className="relative mb-8 md:mb-12 text-center max-w-2xl mx-auto">
        ...
        <p className="text-sm md:text-base text-gray-600 dark:text-gray-300">
          Interactive, customizable fluid elements that add dynamic motion to
          your interface
        </p>
      </div>
        ...
        <div className="rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-800 transition-all hover:shadow-lg flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 md:gap-6">
            <div className="group">
              ...
              <p className="mt-2 text-xs text-center opacity-0 group-hover:opacity-100 transition-opacity">
                Primary
              </p>
            </div>
            ...
            >
              <div className="text-center max-w-[180px]">
                ...
                <p className="text-xs md:text-sm">
                  Create engaging, dynamic UI elements that respond to user
                  interaction
                </p>
              </div>
            </MorphingBlob>
          ...
          <div className="flex justify-center">
            ...
            >
              <div className="text-center max-w-[180px]">
                ...
                <p className="text-xs md:text-sm">
                  Define your own gradient color schemes to match your brand
                  identity
                </p>
              </div>
            </MorphingBlob>
          ...
          <div className="flex justify-center sm:col-span-2 lg:col-span-1">
            ...
            >
              <div className="text-center max-w-[180px]">
                ...
                <p className="text-xs md:text-sm">
                  Blobs adapt seamlessly to different screen sizes and device
                  types
                </p>
              </div>
            </MorphingBlob>
