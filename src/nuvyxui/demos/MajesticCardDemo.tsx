        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8 sm:mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto">
              ...
              >
                <div className="p-8 h-full flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3">Enterprise Plan</h3>
                  <div className="flex items-end gap-1 mb-6">
                    <span className="text-4xl font-bold text-white">$99</span>
                    <span className="text-gray-300 mb-1 text-base">/ month</span>
                  </div>
                  <ul className="space-y-4 mb-8 flex-grow">
                    {["All premium components", "Priority support", "Advanced analytics", "Custom branding"].map(
                      (feature, i) => (
                ...
                <div className="p-8 h-full flex flex-col">
                  ...
                  <div className="space-y-5 mb-6 flex-grow">
                    <div className="flex items-center justify-between">
                      <span className="text-base text-gray-600 dark:text-gray-300">Revenue</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-base text-gray-600 dark:text-gray-300">Active Users</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-base text-gray-600 dark:text-gray-300">Conversion Rate</span>
                      <span className="text-base font-medium">5.2%</span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                      <div className="bg-pink-500 h-2.5 rounded-full" style={{ width: "52%" }}></div>
                    </div>
                  </div>
                  <Button
                    variant="outline"
              ...
              >
                <div className="p-8 h-full flex flex-col">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <Badge className="bg-indigo-900/80 text-indigo-100 text-sm px-3 py-1 rounded-full">Live</Badge>
                  </div>
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="text-indigo-300 text-base">Thunderstorm in Indore</div>
                  </div>
          ...
          <TabsContent value="variants" className="mt-6">
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { name: "Tilt", variant: "tilt", desc: "3D tilt effect on hover", icon: <Cpu /> },
                { name: "Float", variant: "float", desc: "Constant floating animation", icon: <Waves /> },
                {
                  name: "Magnetic",
                  variant: "magnetic",
                ...
                { name: "Layered", variant: "layered", desc: "Multiple layers with parallax", icon: <Layers /> },
                { name: "Morph", variant: "morph", desc: "Shape morphing on hover", icon: <Sparkles /> },
                { name: "Breathe", variant: "breathe", desc: "Pulsating animation effect", icon: <HeartPulse /> },
                { name: "Glow", variant: "glow", desc: "Interactive glow follows cursor", icon: <Zap /> },
                { name: "Wave", variant: "wave", desc: "Wave-like motion effects", icon: <Waves /> },
              ].map((item, i) => (
                <MajesticCard
                  key={i}
                ...
                >
                  <div className="p-6 h-full flex flex-col items-center justify-center">
                    <div className="mb-3 p-3 rounded-full bg-opacity-20 bg-white dark:bg-gray-800 shadow-md">
                      {React.cloneElement(item.icon, { className: "h-6 w-6 text-black dark:text-white" })}
                    </div>
                    <h3 className="text-lg font-semibold mb-2">{item.name}</h3>
                    <p className="text-sm text-center text-gray-500 dark:text-gray-400">{item.desc}</p>
                  </div>
                </MajesticCard>
              ))}
            </div>
              ...
              >
                <div className="relative overflow-hidden">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-gray-400">Move your cursor to explore the depth and parallax effect</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    {[
                      ...
                      >
                        ...
                        <h4 className="text-base font-semibold text-gray-800 dark:text-white mb-2">{item.title}</h4>
                        <p className="text-sm text-center text-gray-500 dark:text-gray-300">Depth: {item.layer}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                >
                  <div className="p-6 text-center h-full flex flex-col">
                    ...
                    <h3 className="font-bold text-lg mb-2 text-teal-800 dark:text-teal-300">Morphing Shape</h3>
                    <p className="text-sm text-teal-600 dark:text-teal-400 mb-6 flex-grow">
                      Hover to see the shape transform with confetti celebration effect
                    </p>
                ...
                >
                  <div className="p-6 text-center h-full flex flex-col">
                    ...
                    <p className="text-sm text-blue-300 mb-6 flex-grow">
                      Experience fluid wave animations that respond to your interactions
                    </p>
                    <Button
                      size="lg"
                      variant="outline"
                ...
                <MajesticCard variant="breathe" theme="cosmic" intensity={3} shadow rounded="xl" hoverEffect>
                  <div className="p-6 text-center h-full flex flex-col">
                    ...
                    <p className="text-sm text-purple-300 mb-6 flex-grow">
                      Subtle pulsating animation that mimics natural breathing rhythm
                    </p>
                    <Button
                      size="lg"
