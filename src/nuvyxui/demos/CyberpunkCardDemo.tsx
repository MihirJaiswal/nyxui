      ...
      >
        <div className="flex flex-col gap-2 p-1 max-w-xs">
          <div className="flex justify-between items-start">
            <h3 className="text-2xl font-bold tracking-tight text-pink-100">Lucy</h3>
          ...
          <div className="relative w-80 h-40 mx-auto">
            <div 
              className="w-full h-full bg-[url('/assets/images/cyberpunk-card/lucy.webp')] bg-cover bg-center rounded-lg"
            />
          </div>
          ...
          <Button 
            className="mt-1 bg-pink-500/20 text-pink-100 hover:bg-pink-500/40 w-full justify-between text-sm"
          >
