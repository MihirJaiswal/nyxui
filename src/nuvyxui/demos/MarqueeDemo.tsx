  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6">
      ...
      <div className="overflow-hidden flex items-center">
        ...
        >
          {/* React */}
          <div className="flex items-center justify-center p-6 rounded-lg h-32 w-32">
              <svg
              role="img"
              viewBox="0 0 32 32"
              xmlns="http://www.w3.org/2000/svg"
              aria-label="React"
              className="size-20 text-cyan-400"
              fill="currentColor"
            >
              <title>React</title>
        ...
        >
          ...
          {/* Tailwind CSS */}
          <div className="flex items-center justify-center p-6 rounded-lg h-32 w-32">
            <svg width="80" height="80" viewBox="0 0 54 33" fill="none" xmlns="http://www.w3.org/2000/svg">
