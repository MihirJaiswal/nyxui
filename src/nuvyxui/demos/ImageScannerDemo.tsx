...
export const ImageScannerDemo = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-3">
      <div className="p-3">
        <h1 className="text-3xl font-bold text-center mb-10 text-gray-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">ImageScanner</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center space-y-4 p-6 transition-all duration-300">
            ...
            <div className="text-center">
              <h3 className="font-bold text-xl text-blue-600 dark:text-blue-400">Click to Scan</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Click on the image to trigger the scan effect</p>
            </div>
          </div>
          <div className="flex flex-col items-center space-y-4 p-6 transition-all duration-300">
            ...
            <div className="text-center">
              <h3 className="font-bold text-xl text-amber-600 dark:text-amber-400">Repeating Scan</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Continuously scans in a loop</p>
            </div>
          </div>
          <div className="flex flex-col items-center space-y-4 p-6 transition-all duration-300">
            <div className="relative">
            ...
            <div className="text-center">
              <h3 className="font-bold text-xl text-red-600 dark:text-red-400">Button Triggered</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Click the button to trigger scanning</p>
            </div>
            <button 
