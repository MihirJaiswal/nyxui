...
import { CodeBlockCommand } from "@/components/components/code-block-command";
import RepoDownload from "@/components/components/repo-download";
import TechStack from "@/components/components/tech-stack";
import TemplatePreview from "@/components/components/template-preview";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
