...
import { Sun, Moon, Check, Copy, Volume2 } from "lucide-react";
...
const MusicCardThemeCustomizer = () => {
  ...
  const isDarkMode =
    mounted &&
    (systemTheme === "dark" || (systemTheme === "system" && syntaxDarkMode));
    ...
    <div className="px-6">
      <div className="max-w-6xl mx-auto">
        <div className="hidden md:flex flex-col lg:flex-row justify-center items-center lg:items-end gap-16">
          ...
          <div className="w-full lg:flex-1 rounded-lg overflow-hidden border border-zinc-300 dark:border-zinc-700 mt-6 lg:mt-0">
