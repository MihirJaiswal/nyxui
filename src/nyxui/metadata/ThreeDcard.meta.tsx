  ...
  props: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: "number",
          default: "15",
          description: "The intensity of the rotation effect in degrees.",
        },
        {
          name: "glareIntensity",
          type: "number",
          default: "0.2",
          description: "The intensity of the glare effect (range: 0-1).",
        },
        {
          name: "shadowIntensity",
          type: "number",
          default: "0.8",
          description: "The intensity of the shadow effect (range: 0-1).",
        },
        {
          name: "hoverScale",
          type: "number",
