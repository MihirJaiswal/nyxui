...
| `scanColor`          | `"emerald" \| "blue" \| "purple" \| "amber" \| "red" \| "cyan" \| "pink"` | `"emerald"`        | Color theme of the scanning effect.                              |
| `scanType`           | `"default" \| "grid" \| "radar" \| "pulse" \| "wave" \| "matrix"`         | `"default"`        | Type of scanning visual effect pattern.                          |
...
| `scanIntensity`      | `"low" \| "medium" \| "high" \| "extreme"`                                | `"medium"`         | Intensity level of the scanning effect.                          |
...
| `triggerScan`        | `boolean`                                                                 | `undefined`        | Externally trigger the scanning effect.                          |
