...
title: Custom Cursor
date: 2025-07-07
description: A custom cursor component with animated follow pointer that replaces the default cursor with customizable SVG icons and name labels.
author: MihirJaiswal
published: true
...
| -------------- | ----------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------ |
| `children`     | `React.ReactNode`                                                                   | **Required** | Content to render with the custom cursor effect.       |
| `className`    | `string`                                                                            | `undefined`  | Additional CSS classes to apply to the container.      |
| `name`         | `string`                                                                            | **Required** | Name displayed next to the cursor pointer.             |
| `customSVG`    | `React.ReactNode`                                                                   | `undefined`  | Custom SVG icon to use instead of the default pointer. |
| `svgClassName` | `string`                                                                            | `undefined`  | Additional CSS classes to apply to the SVG icon.       |
| `cursorColor`  | `"sky" \| "red" \| "green" \| "blue" \| "purple" \| "pink" \| "yellow" \| "indigo"` | `"sky"`      | Color theme for the cursor.                            |

### FollowCursor Component

| Prop           | Type              | Default      | Description                                            |
| -------------- | ----------------- | ------------ | ------------------------------------------------------ |
| `x`            | `MotionValue`     | **Required** | X position motion value for the cursor.                |
| `y`            | `MotionValue`     | **Required** | Y position motion value for the cursor.                |
| `name`         | `string`          | **Required** | Name displayed next to the cursor pointer.             |
| `customSVG`    | `React.ReactNode` | `undefined`  | Custom SVG icon to use instead of the default pointer. |
| `svgClassName` | `string`          | `undefined`  | Additional CSS classes to apply to the SVG icon.       |
