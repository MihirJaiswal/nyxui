...
<ComponentPreview name="animated-code-block-demo1" />

### Terminal

<ComponentPreview name="animated-code-block-demo2" />

### Minimal

<ComponentPreview name="animated-code-block-demo3" />
...
| ----------------- | -------------------------------------------------- | ---------------- | ----------------------------------------------------------------- |
| `code`            | `string`                                           | **Required**     | The code to display and animate                                   |
| `theme`           | `"dark" \| "terminal" \| "minimal" \| "parchment"` | `"dark"`         | The visual theme                                                  |
...
| `title`           | `string`                                           | `"Code Example"` | Title to display in the header                                    |
