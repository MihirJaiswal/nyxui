...
<ComponentPreview name="github-repo-card-demo3" />
...
| `theme`     | `string`   | `modern-light` | Visual theme for the card. Available options: "modern-dark", "modern-light", "cyberpunk", "neo-brutalist". |
