...
| --------------- | ----------------------------------------------------------- | ----------- | --------------------------------------------------------------------- |
| `size`          | `number \| string`                                          | `400`       | The size of the blob container (number for pixels, or any CSS string) |
| `theme`         | `"primary" \| "aurora" \| "cosmic" \| "liquid" \| "danger"` | `"aurora"`  | The color theme of the blob                                           |
