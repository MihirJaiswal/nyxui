...
| --------------------- | -------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------ |
| `coverImage`          | `string`                                                 | **Required**                                                       | URL for the cover image.                                     |
| `titleImage`          | `string`                                                 | **Required**                                                       | URL for the title image.                                     |
| `characterImage`      | `string`                                                 | **Required**                                                       | URL for the character image.                                 |
...
| `characterTranslateY` | `number`                                                 | `-15`                                                              | Y-axis translation for character image on hover.             |
