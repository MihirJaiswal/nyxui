...
| `constrainToContent` | `boolean`                    | `false`                                      | Whether to constrain the slider drag to the content area             |
...
| `layer`     | `"first" \| "second"` | **Required** | Which side of the divider this image appears on                  |
| `loading`   | `"lazy" \| "eager"`   | `"eager"`    | Image loading behavior                                           |
