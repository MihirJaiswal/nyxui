...
<ComponentPreview name="grainy-background-demo" />
...
```bash
npx shadcn@latest add "https://nyxui.com/r/grainy-background.json"
```
...
<ComponentSource name="grainy-background" />
...
<ComponentPreview name="grainy-background-demo1" />

### Pricing Cards

<ComponentPreview name="grainy-background-demo2" />
