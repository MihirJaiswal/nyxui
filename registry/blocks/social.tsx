    ...
    <section className="relative pt-20 pb-24 px-6 overflow-hidden">
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mt-12 z-20">
          <ThreeDLayeredCard
            logo="https://placehold.co/32x32/1da1f2/white?text=X"
            logoSize={32}
            mainImage="https://placehold.co/400x300/1da1f2/white?text=Twitter"
            borderColor="#374153"
            borderWidth="1px"
            glowGradient="#9FA2AA"
          ...
          <ThreeDLayeredCard
            logo="https://placehold.co/100x100/0077b5/white?text=in"
            logoSize={100}
            logoPosition={{ expanded: -12 }}
            mainImage="https://placehold.co/400x300/0077b5/white?text=LinkedIn"
            borderColor="#34CEEE"
            borderWidth="1px"
            glowGradient="#34CEEE"
          ...
          <ThreeDLayeredCard
            logo="https://placehold.co/44x44/181717/white?text=GH"
            logoSize={44}
            mainImage="https://placehold.co/400x300/181717/white?text=GitHub"
            borderColor="#404040"
            borderWidth="1px"
            glowGradient="#737373"
