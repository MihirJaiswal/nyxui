...
export const MorphingBlobDemo = () => {
  return (
    <div className="md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 bg-white dark:bg-black w-full h-full rounded-xl">
      <div className="w-full flex flex-col md:flex-row gap-0 md:gap-24 items-center justify-center rounded-full md:mt-10">
