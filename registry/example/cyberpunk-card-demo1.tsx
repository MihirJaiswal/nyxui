  ...
  return (
    ...
    >
      <div className="space-y-4 sm:space-y-6">
        <div className="relative bg-purple-900/80 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-purple-400/20 backdrop-blur-sm overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="relative p-2 bg-purple-800/50 rounded-lg border border-purple-400/20">
            ...
            <div className="flex flex-col items-end gap-1">
              <div className="px-3 py-1.5 bg-green-900/30 rounded-full text-xs border border-green-400/20 flex items-center gap-2 backdrop-blur-sm">
        ...
        <div className="space-y-3">
          <div className="relative">
            ...
            <div className="relative w-full h-3 bg-purple-950/80 rounded-full overflow-hidden border border-purple-500/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 to-cyan-600/10 rounded-xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
            <div className="relative bg-purple-950/60 p-4 rounded-xl border border-purple-400/20 backdrop-blur-sm overflow-hidden">
              ...
              <div className="mt-6 relative">
                <Image
                  ...
                  width={400}
                  height={350}
                  className="object-cover rounded-lg border border-purple-500/20 max-h-84"
                  quality={100}
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-purple-950/60 to-transparent rounded-lg"></div>
          ...
          <div className="relative">
            <div className="bg-purple-900/60 p-4 rounded-xl border border-purple-400/20 backdrop-blur-sm h-full overflow-hidden">
              <div
              ...
              <div className="relative space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3 bg-green-900/25 px-3 py-2 rounded-lg border border-green-400/20">
                    <span className="text-green-300 font-bold tracking-wider">
                      SECURED & ENCRYPTED
                    </span>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-red-900/25 px-3 py-2 rounded-lg border border-red-400/20">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="bg-purple-800/30 px-2 py-2 rounded border border-purple-500/20">
        ...
        <div className="relative">
          <div className="relative flex flex-wrap justify-between items-center text-xs font-mono pt-3 gap-2">
            <div className="flex items-center gap-2 flex-wrap">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-purple-800/30 rounded-full border border-purple-500/20">
                <Shield className="w-3 h-3 text-purple-400" />
                <span className="text-purple-200">ICE: 3/7</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 bg-cyan-800/30 rounded-full border border-cyan-500/20">
                <Cpu className="w-3 h-3 text-cyan-400" />
                <span className="text-cyan-200">CPU: 42%</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 bg-pink-800/30 rounded-full border border-pink-500/20">
