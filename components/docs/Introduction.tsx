...
export default function IntroductionPage() {
  return (
    <div className="sm:container py-4 mx-auto">
      <div className="space-y-10">
        <div>
          <h2 className="text-3xl font-bold tracking-tight mb-4">
            What is Nyx UI?
          </h2>
          <p className="md:text-lg leading-1.6 text-gray-700 dark:text-gray-300 prose">
            Nyx UI is a set of reusable components, templates, and blocks
            designed for seamless integration into your web projects. It focuses
            on offering components, blocks, and templates ideal for building
            landing pages and UI elements with a creative touch and meticulous
            design.
          </p>
        </div>
        <Separator className="md:col-span-3 mb-2" />
        <div className="md:col-span-3 mt-10" id="faq">
            ...
            <AccordionItem value="getting-started" className="py-2">
              ...
              <AccordionContent>
                <p className="text-gray-700 dark:text-gray-300">
                  Nyx UI offers components that are ready to be integrated into
                  your web projects. Every component is self-contained and
                  developed using contemporary React techniques, ensuring a
            ...
            <AccordionItem value="community-and-support" className="py-2">
              ...
              <AccordionContent>
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  dimensions, and behaviors to align with your brand and unique
                  needs.
                </p>
              </AccordionContent>
            </AccordionItem>
