...
const componentMeta: Record<string, PlaygroundComponentMeta> = {
  ...
  "halo-ring": { dependencies: ["motion"], exportName: "HaloRing" },
  "flip-text": { dependencies: ["motion"], exportName: "FlipText" },
};
...
const componentLoaders: Record<string, () => Promise<ComponentModule>> = {
  ...
  "halo-ring": () => import("@/registry/ui/halo-ring"),
  "flip-text": () => import("@/registry/ui/flip-text"),
};
  ...
  scribble: {
    ...
    props: {
      word: {
        ...
        default: "Episode",
        label: "Word",
        description: "The word to circle",
      },
      variant: {
        type: "select",
        ...
        default: "circle",
        label: "Variant",
        description: "Scribble shape",
      },
      stroke: {
        type: "color",
        default: "#FACC15",
        label: "Stroke Color",
        description: "Pen color of the circle",
      },
      strokeWidth: {
        type: "number",
        default: 3,
      ...
      className: {
        ...
        default: "",
        label: "Class Name",
        description: "Extra classes on the wrapping span",
      },
    },
  },
  ...
  "halo-ring": {
    ...
    props: {
      ...
      colors: {
        ...
        label: "Colors",
        description: "Colors of the rotating sweep",
        category: "Appearance",
      },
      haloRange: {
        type: "object",
        default: [62, 96],
        label: "Halo Range",
        description: "Mask fade [innerStart, outerEnd] %",
        category: "Appearance",
      },
      haloBlur: {
        type: "number",
      ...
      className: {
        ...
        default: "rounded-3xl",
        label: "Class Name",
        description: "Wrapper classes (radius, max width)",
        category: "Appearance",
      },
      innerClassName: {
        type: "classnames",
        default: "rounded-3xl bg-neutral-900 p-6 text-center text-white",
        label: "Inner Class",
        description: "Classes for the card surface inside the halo",
        category: "Appearance",
      },
      children: {
        type: "textarea",
        default: `AI Card Content`,
        label: "Children Content",
        description: "Content rendered inside the bordered card",
        category: "Content",
      },
    },
  },
  ...
  "flip-text": {
    ...
    props: {
      text: {
        ...
        default: "Instagram",
        label: "Text",
        description: "String whose characters flip on hover",
        category: "Content",
      },
      duration: {
        type: "number",
        ...
        step: 0.05,
        label: "Duration",
        description: "Per-character animation length (seconds)",
        category: "Animation",
      },
      stagger: {
        type: "number",
        ...
        step: 0.005,
        label: "Stagger",
        description: "Delay between each character (seconds)",
        category: "Animation",
      },
      href: {
        type: "string",
        default: "",
        label: "Href",
        description: "Render an anchor when set",
        category: "Content",
      },
      className: {
        type: "classnames",
        default:
          "text-4xl font-black uppercase text-foreground sm:text-5xl md:text-6xl",
        label: "Class Name",
      ...
      overlayClassName: {
        ...
        description: "Classes on the duplicate hover layer",
        category: "Appearance",
      },
    },
  },
  ...
  "pop-text": {
    ...
    props: {
      ...
      hoverColor: {
        ...
        default: "#e0e7ff",
        label: "Hover Color",
        description: "Color of the hovered letter",
      },
      className: {
        type: "classnames",
        default: "",
