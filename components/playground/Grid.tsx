...
export function Grid() {
  return (
    <div className="relative flex h-[35vh] lg:h-[calc(85vh+3rem)] w-full flex-col items-center justify-center overflow-hidden rounded-xl rounded-b-none border-0 border-b border-border bg-muted mb-2 lg:rounded-xl lg:border lg:mb-0">
      <motion.div
