  ...
  return (
    <section className="relative pt-16 pb-24 px-6 mb-12 overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-12 z-20">
          <ThreeDLayeredCard
            ...
            borderWidth="1px"
            glowGradient="#52525C"
            backgroundColor="bg-gradient-to-b from-zinc-800 via-zinc-900 to-black"
            shineIntensity={0.6}
          >
            ...
            <p className="text-sm text-neutral-200 mb-2">
              ...
              >
                <Button className="group relative overflow-hidden bg-gradient-to-r from-zinc-500/90 via-zinc-600/90 to-zinc-700/90 backdrop-blur-sm border border-zinc-400/30 hover:from-zinc-400/90 hover:via-zinc-500/90 hover:to-zinc-600/90 text-white shadow-lg hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-0.5 px-4 py-2 rounded-lg">
