...
export default function SocialProof() {
  const avatars = [
    ...
    { id: 2, src: "/assets/images/avtars/4.jpeg", alt: "Founder 2" },
    { id: 3, src: "/assets/images/avtars/5.jpeg", alt: "Founder 3" },
    { id: 4, src: "/assets/images/avtars/9.jpeg", alt: "Founder 4" },
    { id: 5, src: "/assets/images/avtars/6.jpeg", alt: "Founder 5" },
  ]
