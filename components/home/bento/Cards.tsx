      ...
      <div className="flex flex-col items-center justify-center group relative z-10">
        <div className="flex justify-center items-center">
          {cards.map((card, index) => (
            <div
              key={index}
              className="glass-card w-44 h-52 flex justify-center items-center transition-all duration-500 ease-in-out rounded-lg border-2 border-white/30 backdrop-blur-md"
              style={{
