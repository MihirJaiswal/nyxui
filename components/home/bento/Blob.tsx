  ...
  return (
    <div className="w-full h-full max-w-full max-h-full overflow-hidden relative"> 
      ...
      <div className="flex flex-col items-center justify-center group h-full">
        ...
        <div className="absolute -z-1 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-72 w-66 bg-radial from-black via-purple-950/5 to-purple-400 rounded-full blur-xl  shadow-[0_0_50px_rgba(96,165,250,0.4)]" />
